...
<div className="inpts">
    ...
    <input className="inp" type="email" name="email" onChange={OnChange} onBlur={onBlur}
...
<div className="inpts">
    ...
    <input className="inp" type="password" name="password" onChange={OnChange} onBlur={onBlur} 
